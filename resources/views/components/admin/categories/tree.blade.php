        ...
        <li class="py-2">
            <div class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-3">
                    @if ($category->image)
                        <img src="{{ Storage::url($category->image) }}" class="h-8 w-8 rounded-md object-cover" alt="">
                    @endif
                ...
                <div class="flex items-center gap-3 text-sm">
                    <a href="{{ route('admin.categories.edit', $category->id) }}" class="text-ink/60 transition-colors hover:text-ink hover:underline">
                        Edit
                    </a>
