...
<div data-component="front/layouts/header/cart-modal" class="contents">
    <div
        data-cart-modal-backdrop
    ...
    >
        <div class="flex items-center justify-between border-b border-ink/10 px-6 py-5">
            <span class="font-serif text-lg text-ink">Кошик</span>
            <button type="button" data-cart-modal-close aria-label="{{ __('header.close_menu') }}" class="text-ink/60">
        ...
        <div class="flex-1 px-6 py-6">
            <x-front.cart :fetch-url="route('front.cart.show')" />
        </div>
    </div>
</div>
